		...
		template: `
			<div>
				<div v-for="opt in options" :key="opt.value" class="flex align-items-center gap-2">
					<BccRadioButton v-model="selected" :input-id="opt.value" name="group" :value="opt.value" v-bind="args" />
	...
	render: () => ({
		...
		template: `
			<div class="flex align-items-center gap-2">
				<BccRadioButton v-model="selected" input-id="rb-disabled" name="dg" value="opt1" disabled />
