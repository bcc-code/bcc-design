	...
	render: () => ({
		...
		template: `
			<div class="flex flex-col">
				...
				<p class="body-md text-subtlest mt-2">* Token values are subject to change and should be used as an indication only.</p>
			</div>
		`,
	}),
};
		...
		template: `
			<div class="bg-neutral-100 rounded-lg p-8 flex gap-8 items-start justify-center">
				...
				<div class="flex flex-col gap-3 w-52">
					...
					<div class="h-10 rounded-md border border-default bg-elevation-surface-default px-3 flex items-center justify-between">
					...
					<div class="flex flex-col rounded-sm border border-default overflow-hidden bg-elevation-surface-default" style="box-shadow: 0 4px 16px rgba(0,0,0,0.08)">
						...
						<div class="px-3 py-2 text-sm border-b border-default bg-neutral-100">Menu item</div>
...
export const PairingExample: Story = {
	render: () => ({
		template: `
			<div class="bg-neutral-100 rounded-lg p-8 flex gap-6 justify-center items-start">
				<div class="flex flex-col items-center gap-2">
					<div class="w-28 h-10 rounded-md bg-elevation-surface-default border border-input flex items-center px-3">
						<span class="text-sm text-subtlest">Rest</span>
					</div>
					<span class="body-md text-subtlest">1px · input</span>
				</div>
				<div class="flex flex-col items-center gap-2">
					<div class="w-28 h-10 rounded-md bg-elevation-surface-default border-2 border-focused flex items-center px-3">
						<span class="text-sm text-default">Focused</span>
					</div>
					<span class="body-md text-subtlest">2px · focused</span>
				</div>
				<div class="flex flex-col items-center gap-2">
					<div class="w-28 h-10 rounded-md bg-elevation-surface-default border-2 border-selected flex items-center px-3">
						<span class="text-sm text-default">Selected</span>
					</div>
					<span class="body-md text-subtlest">2px · selected</span>
				</div>
				<div class="flex flex-col items-center gap-2">
					<div class="w-28 h-10 rounded-md bg-elevation-surface-default border border-disabled flex items-center px-3">
