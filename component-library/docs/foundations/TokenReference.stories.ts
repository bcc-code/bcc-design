...
export const ColorBgBrand: Story = {
	render: () => ({
		...
		setup: () => ({
			tokens: [
				c('color.background.brand.subtlest', 'Subtle brand tint for backgrounds.', 'Bcc100', 'Bcc1000'),
				c('color.background.brand.subtler', undefined, 'Bcc200', 'Bcc900'),
				c('color.background.brand.subtle', undefined, 'Bcc400', 'Bcc700'),
				c('color.background.brand.bolder', 'Primary buttons, strong brand emphasis.', 'Bcc800', 'Bcc300'),
				c('color.background.brand.boldest', undefined, 'Bcc1000', 'Bcc100'),
			],
		}),
	}),
};
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.background.success.bolder', undefined, 'Green700', 'Green400'),
				c('color.background.information.default', undefined, 'Blue100', 'Blue1000'),
				c('color.background.information.bolder', undefined, 'Blue700', 'Blue400'),
				c('color.background.danger.default', undefined, 'Red100', 'Red1000'),
				c('color.background.danger.bolder', undefined, 'Red700', 'Red400'),
				c('color.background.warning.default', undefined, 'Yellow100', 'Yellow1000'),
				c('color.background.warning.bolder', undefined, 'Yellow300', 'Yellow400'),
			],
		}),
	}),
};
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.background.selected.bold', 'Bold selected — active tabs, pills.', 'Bcc700', 'Bcc400'),
			],
		}),
	}),
};
...
export const ColorBgAlpha: Story = {
	render: () => ({
		...
		setup: () => ({
			tokens: [
				c('color.background.alpha.subtlest', 'Fully transparent.', 'Transparent', 'Transparent'),
				c('color.background.alpha.subtler', undefined, 'Alpha 3%', 'Alpha 4%'),
				c('color.background.alpha.subtle', undefined, 'Alpha 6%', 'Alpha 7%'),
				c('color.background.alpha.default', undefined, 'Alpha 14%', 'Alpha 12%'),
				c('color.background.alpha.bold', undefined, 'Alpha 46%', 'Alpha 36%'),
			],
		}),
	}),
};
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.background.disabled', 'Disabled element backgrounds.', 'Alpha 6%', 'Alpha 7%'),
			],
		}),
	}),
};
...
export const AccentBgSubtlest: Story = {
	render: () => ({
		...
		setup: () => ({
			tokens: [
				c('color.background.accent.gray.subtlest', undefined, 'Neutral0', 'DarkNeutral0'),
				c('color.background.accent.blue.subtlest', undefined, 'Blue100', 'Blue1000'),
				c('color.background.accent.teal.subtlest', undefined, 'Teal100', 'Teal1000'),
				c('color.background.accent.green.subtlest', undefined, 'Green100', 'Green1000'),
				c('color.background.accent.brown.subtlest', undefined, 'Brown100', 'Brown1000'),
				c('color.background.accent.yellow.subtlest', undefined, 'Yellow100', 'Yellow1000'),
				c('color.background.accent.orange.subtlest', undefined, 'Orange100', 'Orange1000'),
				c('color.background.accent.red.subtlest', undefined, 'Red100', 'Red1000'),
				c('color.background.accent.magenta.subtlest', undefined, 'Magenta100', 'Magenta1000'),
				c('color.background.accent.purple.subtlest', undefined, 'Purple100', 'Purple1000'),
			],
		}),
	}),
};
