	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.text.subtlest', '#7d818a', '#7e8188', 'Tertiary text — captions, placeholders.', 'Neutral600', 'DarkNeutral600'),
				...
				c('color.text.selected', '#0c625c', '#6fb5ad', 'Selected element text.', 'Bcc700', 'Bcc400'),
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.text.warning.inverse', '#4b2c04', '#1f1f21', 'Text on warning bolder backgrounds.', 'Yellow900', 'DarkNeutral100'),
				c('color.text.brand.default', '#014d49', '#6fb5ad', undefined, 'Bcc800', 'Bcc400'),
...
export const ColorLink: Story = {
	render: () => ({
		...
		setup: () => ({
			tokens: [
				c('color.link.default', '#273c8f', '#7cabf9', 'Default link color.', 'Blue800', 'Blue400'),
				c('color.link.pressed', '#212c64', '#a6cdfd', 'Active/pressed link.', 'Blue900', 'Blue300'),
				c('color.link.visited.default', '#493481', '#c9c3ec', 'Visited link.', 'Purple800', 'Purple300'),
				c('color.link.visited.hover', '#352465', '#e3e3fe', 'Visited link hover.', 'Purple900', 'Purple200'),
			],
		}),
	}),
};
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.icon.subtlest', '#7d818a', '#7e8188', 'Tertiary icon.', 'Neutral600', 'DarkNeutral600'),
				...
				c('color.icon.selected', '#0c625c', '#6fb5ad', undefined, 'Bcc700', 'Bcc400'),
				c('color.icon.success', '#094c3b', '#1ca673', undefined, 'Green800', 'Green500'),
				c('color.icon.information', '#273c8f', '#608ef6', undefined, 'Blue800', 'Blue500'),
				c('color.icon.danger', '#811436', '#ed6362', undefined, 'Red800', 'Red500'),
				c('color.icon.warning.default', '#653805', '#e9c348', undefined, 'Yellow800', 'Yellow300'),
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.border.selected', '#0c625c', '#6fb5ad', undefined, 'Bcc700', 'Bcc400'),
				c('color.border.focused', '#505258', '#a9abaf', 'Focus ring on interactive elements.', 'Neutral800', 'DarkNeutral800'),
				c('color.border.input', '#8c8f97', '#63666b', 'Form input borders at rest.', 'Neutral500', 'DarkNeutral500'),
				c('color.border.brand', '#0c625c', '#6fb5ad', undefined, 'Bcc700', 'Bcc400'),
				...
				c('color.border.warning', '#b55919', '#bc870d', undefined, 'Orange600', 'Yellow500'),
				c('color.border.inverse', '#ffffff', '#18191a', 'Borders on inverted backgrounds.', 'Neutral0', 'DarkNeutral0'),
			],
		}),
	}),
};
	...
	render: () => ({
		...
		setup: () => ({
			tokens: [
				...
				c('color.background.brand.subtle', '#6fb5ad', '#0c625c', undefined, 'Bcc400', 'Bcc700'),
				c('color.background.brand.bolder', '#014d49', '#a0cec8', 'Primary buttons, strong brand emphasis.', 'Bcc800', 'Bcc300'),
				c('color.background.brand.boldest', '#012320', '#f0fcfa', undefined, 'Bcc1000', 'Bcc100'),
			],
		}),
	}),
};
...
export const ColorBgStatus: Story = {
	render: () => ({
		...
		setup: () => ({
			tokens: [
				c('color.background.success.default', '#efffed', '#032429', undefined, 'Green100', 'Green1000'),
				c('color.background.success.bolder', '#0c6241', '#32c180', undefined, 'Green700', 'Green400'),
				c('color.background.information.default', '#f6fbff', '#091e47', undefined, 'Blue100', 'Blue1000'),
				c('color.background.information.bolder', '#274eb5', '#7cabf9', undefined, 'Blue700', 'Blue400'),
				c('color.background.danger.default', '#fff8f3', '#440223', undefined, 'Red100', 'Red1000'),
				c('color.background.danger.bolder', '#a42237', '#fa877e', undefined, 'Red700', 'Red400'),
				c('color.background.warning.default', '#fdf8e9', '#2d1f00', undefined, 'Yellow100', 'Yellow1000'),
				c('color.background.warning.bolder', '#e9c348', '#d5a406', undefined, 'Yellow300', 'Yellow400'),
			],
		}),
	}),
};
