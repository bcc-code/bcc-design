...
- [`/docs-index.json`](/docs-index.json): machine-readable index with source paths, docs routes, Markdown routes, and summaries.
...
MCP server generation is out of scope. This pipeline only publishes static Markdown and JSON files.
