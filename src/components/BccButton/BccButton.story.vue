...
[Button guidelines](https://bccit.notion.site/2-1-Buttons-Component-030f871e026344a9a6770561b609d36c)
</docs>

<template>
  <Story>
    <Variant title="Example">
      <BccButton :variant="variant">{{ label }}</BccButton>
